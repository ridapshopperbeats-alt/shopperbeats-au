        ...
        <form className="w-full" onSubmit={handleSubmit(handleForgotPasswordSubmit)} noValidate>
          <div className="form-item">
            <input
              ...
              disabled={isLoading}
              className="input-rounded-lg flex h-[46px] items-center gap-[10px] px-[17px] py-[10px] flex-[1_0_0] placeholder:text-[#000] placeholder:font-montserrat placeholder:text-[16px] placeholder:not-italic placeholder:font-medium placeholder:leading-normal"
            />
