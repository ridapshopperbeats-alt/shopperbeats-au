...
<div className={`w-full ${className}`}>
  {title && (
    <h1 className={`text-center text-[20px] font-bold leading-[30px] text-black lg:pt-4 ${titleClassName}`}>
      {title}
    </h1>
  )}
    ...
    {arrows && (
      <>
        ...
        <button
          ...
          className="hidden lg:flex absolute right-6 top-20 -translate-y-1/2 z-20 w-9 h-9 rounded-full bg-white border border-gray-200 items-center justify-center cursor-pointer shadow-md hover:bg-gray-50 transition-all"
        >
