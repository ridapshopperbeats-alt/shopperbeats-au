...
const CATEGORIES: Category[] = [
  { id: 1, title: 'Home & Garden', imageUrl: '/images/tc_homegarden.jpg', href: "/category/home" },
...
export const TopCategories = () => {
  ...
  return (
    <section className="w-full bg-transparent mb-8">
      <div className="container mx-auto relative px-4 md:px-8 max-w-[1750px]">

        <h3 className="font-bold text-gray-900 tracking-tight text-[35px] text-center" style={{ marginTop: "10px", marginBottom: "20px" }} >
          Top Categories123
        </h3>
