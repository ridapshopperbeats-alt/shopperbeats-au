...
ShopperBeats AU is a modern e-commerce frontend application built with Next.js and React. The application provides product browsing, category navigation, shopping cart, wishlist, checkout, payment, AUer account, order management, and other e-commerce functionality for the AU storefront.
